...
// Suppose you call ArrayBasedQueue::enqueue n times.
// What is the (worst-case) running time of a single call to ArrayBasedQueue::enqueue?
...
double time_queue_operations(Queue & queue, const size_t num_elements) { 
    ...
    return chrono::duration_cast<chrono::milliseconds>(run_time).count()/5.0;
}
